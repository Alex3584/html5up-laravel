            ...
            <div class="inner">
                ...
                <section>
                    ...
                    <p>Praesent ac adipiscing ullamcorper semper ut amet ac risus. Lorem sapien ut odio odio nunc. Ac
                        ...
                        eget accumsan ac nunc adipiscing adipiscing lorem ipsum dolor sit amet nullam veroeros adipiscing.
                    </p>
                    <div class="row">
                        ...
                        <div class="col-6 col-12-small">
                            ...
                            <p>In arcu accumsan arcu adipiscing accumsan orci ac. Felis id enim aliquet. Accumsan ac integer
                                ...
                                arcu ornare odio mi adipiscing nascetur lacus ac interdum morbi accumsan vis mi accumsan.
                            </p>
                        </div>
                        <!-- Break -->
                    ...
                    <div class="row gtr-200">
                        ...
                        <div class="col-6 col-12-medium">
                            ...
                            <div class="box alt">
                                <div class="row gtr-50 gtr-uniform">
                                    <div class="col-4"><span class="image fit"><img
                                                src="{{ asset('images/pic01.jpg') }}" alt="" /></span></div>
                                    <div class="col-4"><span class="image fit"><img
                                                src="{{ asset('images/pic02.jpg') }}" alt="" /></span></div>
                                    <div class="col-4"><span class="image fit"><img
                                                src="{{ asset('images/pic03.jpg') }}" alt="" /></span></div>
                                    <div class="col-4"><span class="image fit"><img
                                                src="{{ asset('images/pic03.jpg') }}" alt="" /></span></div>
                                    <div class="col-4"><span class="image fit"><img
                                                src="{{ asset('images/pic01.jpg') }}" alt="" /></span></div>
                            ...
                            <h4>Left &amp; Right</h4>
                            <p><span class="image left"><img src="{{ asset('images/pic01.jpg') }}"
                                ...
                                Integer ac pellentesque praesent tincidunt felis sagittis eget. tempus euismod. Vestibulum
                            ...
                            <p><span class="image right"><img src="{{ asset('images/pic02.jpg') }}"
                                        alt="" /></span>Lorem ipsum dolor sit accumsan interdum nisi, quis
                                tincidunt felis sagittis eget. tempus euismod. Vestibulum ante ipsum primis in faucibus
                                vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan eu faucibus.
                                Integer ac pellentesque praesent tincidunt felis sagittis eget. tempus euismod. Vestibulum
            ...
            <div class="inner">
                ...
                <section>
                    ...
                    <div class="mini-posts">
                        <article>
                            <a href="#" class="image"><img src="{{ asset('images/pic07.jpg') }}"
                                    alt="" /></a>
                            <p>Aenean ornare velit lacus, ac varius enim lorem ullamcorper dolore aliquam.</p>
                        </article>
                        <article>
                            <a href="#" class="image"><img src="{{ asset('images/pic08.jpg') }}"
                                    alt="" /></a>
                            <p>Aenean ornare velit lacus, ac varius enim lorem ullamcorper dolore aliquam.</p>
                        </article>
                        <article>
                            <a href="#" class="image"><img src="{{ asset('images/pic09.jpg') }}"
                                    alt="" /></a>
                            <p>Aenean ornare velit lacus, ac varius enim lorem ullamcorper dolore aliquam.</p>
                        </article>
                    </div>
